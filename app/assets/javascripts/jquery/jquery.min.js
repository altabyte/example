...
(function (a, b) {
        ...
        e.fn = e.prototype = {
            constructor: e, init: function (a, d, f) {
                ...
                if (typeof a == "string") {
                    ...
                    if (g && (g[1] || !d)) {
                        if (g[1]) {
                            d = d instanceof e ? d[0] : d, k = d ? d.ownerDocument || d : c, j = m.exec(a), j ? e.isPlainObject(d) ? (a = [c.createElement(j[1])], e
                        .
                            fn.attr.call(a, d, !0)
                        ) :
    ...
    f.fn.extend({
        ...
        get: function (a, c) {
            ...
            in
            a && (a[d] = !0), a.setAttribute(c, c.toLowerCase())
            )
            ;
            return c
        }
    ...
    f.event = {
        ...
        on: function (a, c, d, e, g) {
            ...
            ==
            null && (typeof c == "string" ? (e = d, d = b): (e = d, d = c, c = b));
            ...
            return {
                send: function (e, g) {
                    ...
                    h.send(c.hasContent && c.data || null), d = function (a, e) {
                        ...
                        m && g(j, k, m, l)
                    }, !c.async || h.readyState === 4 ? d() : (i = ++cg, cf
                    &&
                    (ch || (ch = {}, f(a).unload(cf)), ch[i] = d), h.onreadystatechange = d
                    )
                }, abort: function () {
                    d && d(0, 1)
                }
    ...
    f.fn.extend({
        show: function (a, b, c) {
            ...
            function g() {
                ...
                for (i in a)j = new f.fx(this, b, i), h = a[i], cn.test(h) ? (o = f._data(this, "toggle" + i) || (h === "toggle" ? d ? "show" : "hide" : 0), o ? (f._data(this, "toggle" + i, o === "show" ? "hide" : "show"), j[o]()) : j[h]()
            ) :
                (k = co.exec(h), l = j.cur(), k
                ? (m = parseFloat(k[2]), n = k[3] || (f.cssNumber[i] ? "" : "px"), n
            !==
                "px" && (f.style(this, i, (m || 1) + n), l = (m || 1) / j.cur() * l, f.style(this, i, l + n)), k[1] && (m = (k[1] === "-=" ? -1 : 1) * m + l), j.custom(l, m, n)
            ) :
                j.custom(l, h, "")
            )
                ;
        ...
        update: function () {
            ...
            this.state = c / i.duration, this.pos = f.easing[i.animatedProperties[this.prop]](this.state, c, 0, 1, i.duration), this.now = this.start + (this.end - this.start) * this.pos
            ),
            this.update();
            return !0
        }

# Use this hook to configure devise11 mailer, warden hooks and so forth.
# Many of these configuration options can be set straight in your model.
Devise.setup do |config|

  #config.secret_key = '7b56897b6533193b04b75aaf2928c4ec6389094577a9129214c8fc40f0223eada2e9a55eca3bd0e64d387e5864784b1f416f47dffef89aebeb4b57c1f10597b6'
  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class with default "from" parameter.
  config.mailer_sender = "control@ordermanager.biz"
  ...
  # config.pepper = "844e6c887ddfab0de59628ec93b11e0c521287d8093b9f2a1d94b16c44ba3b260b5ccbb0ed0abf21a7e4c50b93247631930b3bd2092f3d2a244532a55e8e66f3"
  ...
  # devise11 role declared in your routes (usually :user).

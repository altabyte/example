class InitSchema < ActiveRecord::Migration
  def up
    ...
    add_index "order_fraud_scores", ["order_header_id"], :name => "Order_Fraud_Score_UK1", :unique => true
    ...
    add_index "order_headers", ["channel_id", "channel_order_id", "customer_id", "status"], :name => "order_headers_UK1", :unique => true
    ...
    add_index "order_picks", ["order_detail_id", "item_id", "location_id"], :name => "order_picks_UK1", :unique => true
    ...
    add_index "order_shipments", ["order_id", "item_id", "stock_location_id"], :name => "order_shipments_UK1", :unique => true
    ...
    add_index "roles_users", ["role_id", "user_id"], :name => "Roles_Users_UK1"
